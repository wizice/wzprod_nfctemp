...
const NfcAuthenticatorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_nfcauthenticator_free(ptr >>> 0, 1));
...
export class NfcAuthenticator {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        NfcAuthenticatorFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_nfcauthenticator_free(ptr, 0);
    }
    /**
     * @param {string} key_base64
     * @param {string} api_endpoint
     */
    constructor(key_base64, api_endpoint) {
        ...
        const ret = wasm.nfcauthenticator_new(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        NfcAuthenticatorFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * UID를 암호화된 UUID로 변환
    ...
    encrypt_uid(uid) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.nfcauthenticator_encrypt_uid(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     */
    verify_tag(uid, app_version) {
        const ptr0 = passStringToWasm0(uid, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(app_version, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.nfcauthenticator_verify_tag(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret;
    }
    /**
     * 로컬 UID 해시 생성 (빠른 비교용)
    ...
    hash_uid(uid) {
        ...
        try {
            const ptr0 = passStringToWasm0(uid, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.nfcauthenticator_hash_uid(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_2192f841073b2895 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('nfc_auth_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
